...
// 	protoc        v3.15.8
// source: eth/v2/withdrawals.proto
...
func (x *BLSToExecutionChange) Reset() {
	*x = BLSToExecutionChange{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v2_withdrawals_proto_msgTypes[0]
...
func (*BLSToExecutionChange) Descriptor() ([]byte, []int) {
	return file_eth_v2_withdrawals_proto_rawDescGZIP(), []int{0}
}
...
func (x *SignedBLSToExecutionChange) Reset() {
	*x = SignedBLSToExecutionChange{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v2_withdrawals_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SignedBLSToExecutionChange) Descriptor() ([]byte, []int) {
	return file_eth_v2_withdrawals_proto_rawDescGZIP(), []int{1}
}
...
func (x *SubmitBLSToExecutionChangesRequest) Reset() {
	*x = SubmitBLSToExecutionChangesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v2_withdrawals_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SubmitBLSToExecutionChangesRequest) Descriptor() ([]byte, []int) {
	return file_eth_v2_withdrawals_proto_rawDescGZIP(), []int{2}
}
...
var File_eth_v2_withdrawals_proto protoreflect.FileDescriptor

var file_eth_v2_withdrawals_proto_rawDesc = []byte{
...
var (
	file_eth_v2_withdrawals_proto_rawDescOnce sync.Once
	file_eth_v2_withdrawals_proto_rawDescData = file_eth_v2_withdrawals_proto_rawDesc
)

func file_eth_v2_withdrawals_proto_rawDescGZIP() []byte {
	file_eth_v2_withdrawals_proto_rawDescOnce.Do(func() {
		file_eth_v2_withdrawals_proto_rawDescData = protoimpl.X.CompressGZIP(file_eth_v2_withdrawals_proto_rawDescData)
	})
	return file_eth_v2_withdrawals_proto_rawDescData
}

var file_eth_v2_withdrawals_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_eth_v2_withdrawals_proto_goTypes = []interface{}{
...
var file_eth_v2_withdrawals_proto_depIdxs = []int32{
...
func init() { file_eth_v2_withdrawals_proto_init() }
func file_eth_v2_withdrawals_proto_init() {
	if File_eth_v2_withdrawals_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_eth_v2_withdrawals_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eth_v2_withdrawals_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eth_v2_withdrawals_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_eth_v2_withdrawals_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_eth_v2_withdrawals_proto_goTypes,
		DependencyIndexes: file_eth_v2_withdrawals_proto_depIdxs,
		MessageInfos:      file_eth_v2_withdrawals_proto_msgTypes,
	}.Build()
	File_eth_v2_withdrawals_proto = out.File
	file_eth_v2_withdrawals_proto_rawDesc = nil
	file_eth_v2_withdrawals_proto_goTypes = nil
	file_eth_v2_withdrawals_proto_depIdxs = nil
}
