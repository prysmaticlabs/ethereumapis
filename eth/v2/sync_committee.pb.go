...
// 	protoc        v3.15.8
// source: eth/v2/sync_committee.proto
...
func (x *SubmitSyncCommitteeSignaturesRequest) Reset() {
	*x = SubmitSyncCommitteeSignaturesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v2_sync_committee_proto_msgTypes[0]
...
func (*SubmitSyncCommitteeSignaturesRequest) Descriptor() ([]byte, []int) {
	return file_eth_v2_sync_committee_proto_rawDescGZIP(), []int{0}
}
...
func (x *SyncCommitteeMessage) Reset() {
	*x = SyncCommitteeMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v2_sync_committee_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SyncCommitteeMessage) Descriptor() ([]byte, []int) {
	return file_eth_v2_sync_committee_proto_rawDescGZIP(), []int{1}
}
...
func (x *StateSyncCommitteesRequest) Reset() {
	*x = StateSyncCommitteesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v2_sync_committee_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StateSyncCommitteesRequest) Descriptor() ([]byte, []int) {
	return file_eth_v2_sync_committee_proto_rawDescGZIP(), []int{2}
}
...
type StateSyncCommitteesResponse struct {
	...
	Data *SyncCommittee `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
}

func (x *StateSyncCommitteesResponse) Reset() {
	*x = StateSyncCommitteesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v2_sync_committee_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StateSyncCommitteesResponse) Descriptor() ([]byte, []int) {
	return file_eth_v2_sync_committee_proto_rawDescGZIP(), []int{3}
}

func (x *StateSyncCommitteesResponse) GetData() *SyncCommittee {
	if x != nil {
		return x.Data
	}
	return nil
...
type SyncCommittee struct {
	...
	ValidatorAggregates []*SyncSubcommittee                                  `protobuf:"bytes,2,rep,name=validator_aggregates,json=validatorAggregates,proto3" json:"validator_aggregates,omitempty"`
}

func (x *SyncCommittee) Reset() {
	*x = SyncCommittee{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v2_sync_committee_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SyncCommittee) Descriptor() ([]byte, []int) {
	return file_eth_v2_sync_committee_proto_rawDescGZIP(), []int{4}
}

func (x *SyncCommittee) GetValidators() []github_com_prysmaticlabs_eth2_types.ValidatorIndex {
	if x != nil {
		return x.Validators
	}
...
func (x *SyncCommittee) GetValidatorAggregates() []*SyncSubcommittee {
	if x != nil {
...
func (x *SyncSubcommittee) Reset() {
	*x = SyncSubcommittee{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v2_sync_committee_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SyncSubcommittee) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SyncSubcommittee) ProtoMessage() {}

func (x *SyncSubcommittee) ProtoReflect() protoreflect.Message {
	mi := &file_eth_v2_sync_committee_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SyncSubcommittee.ProtoReflect.Descriptor instead.
func (*SyncSubcommittee) Descriptor() ([]byte, []int) {
	return file_eth_v2_sync_committee_proto_rawDescGZIP(), []int{5}
}

func (x *SyncSubcommittee) GetValidators() []github_com_prysmaticlabs_eth2_types.ValidatorIndex {
	if x != nil {
		return x.Validators
	}
	return []github_com_prysmaticlabs_eth2_types.ValidatorIndex(nil)
...
var File_eth_v2_sync_committee_proto protoreflect.FileDescriptor

var file_eth_v2_sync_committee_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x74, 0x61, 0x22, 0x93, 0x02, 0x0a, 0x14, 0x53, 0x79, 0x6e, 0x63, 0x43, 0x6f, 0x6d,
	0x6d, 0x69, 0x74, 0x74, 0x65, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x40, 0x0a,
	...
	0x6f, 0x6f, 0x74, 0x12, 0x5f, 0x0a, 0x0f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72,
	...
	0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x8b, 0x01, 0x0a, 0x1a, 0x53,
	...
	0x74, 0x65, 0x49, 0x64, 0x12, 0x48, 0x0a, 0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x18, 0x02, 0x20,
	...
	0x63, 0x68, 0x48, 0x00, 0x52, 0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x88, 0x01, 0x01, 0x42, 0x08,
	0x0a, 0x06, 0x5f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x22, 0x51, 0x0a, 0x1b, 0x53, 0x74, 0x61, 0x74,
	...
	0x69, 0x74, 0x74, 0x65, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xbd, 0x01, 0x0a, 0x0d,
	0x53, 0x79, 0x6e, 0x63, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x65, 0x12, 0x56, 0x0a,
	...
	,
	...
	0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x42, 0x80, 0x01, 0x0a, 0x13, 0x6f, 0x72, 0x67, 0x2e,
...
var (
	file_eth_v2_sync_committee_proto_rawDescOnce sync.Once
	file_eth_v2_sync_committee_proto_rawDescData = file_eth_v2_sync_committee_proto_rawDesc
)

func file_eth_v2_sync_committee_proto_rawDescGZIP() []byte {
	file_eth_v2_sync_committee_proto_rawDescOnce.Do(func() {
		file_eth_v2_sync_committee_proto_rawDescData = protoimpl.X.CompressGZIP(file_eth_v2_sync_committee_proto_rawDescData)
	})
	return file_eth_v2_sync_committee_proto_rawDescData
}

var file_eth_v2_sync_committee_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_eth_v2_sync_committee_proto_goTypes = []interface{}{
	(*SubmitSyncCommitteeSignaturesRequest)(nil), // 0: ethereum.eth.v2.SubmitSyncCommitteeSignaturesRequest
	(*SyncCommitteeMessage)(nil),                 // 1: ethereum.eth.v2.SyncCommitteeMessage
	(*StateSyncCommitteesRequest)(nil),           // 2: ethereum.eth.v2.StateSyncCommitteesRequest
	(*StateSyncCommitteesResponse)(nil),          // 3: ethereum.eth.v2.StateSyncCommitteesResponse
	(*SyncCommittee)(nil),                        // 4: ethereum.eth.v2.SyncCommittee
	(*SyncSubcommittee)(nil),                     // 5: ethereum.eth.v2.SyncSubcommittee
}
var file_eth_v2_sync_committee_proto_depIdxs = []int32{
	1, // 0: ethereum.eth.v2.SubmitSyncCommitteeSignaturesRequest.data:type_name -> ethereum.eth.v2.SyncCommitteeMessage
	4, // 1: ethereum.eth.v2.StateSyncCommitteesResponse.data:type_name -> ethereum.eth.v2.SyncCommittee
	5, // 2: ethereum.eth.v2.SyncCommittee.validator_aggregates:type_name -> ethereum.eth.v2.SyncSubcommittee
...
func init() { file_eth_v2_sync_committee_proto_init() }
func file_eth_v2_sync_committee_proto_init() {
	if File_eth_v2_sync_committee_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_eth_v2_sync_committee_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eth_v2_sync_committee_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eth_v2_sync_committee_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eth_v2_sync_committee_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eth_v2_sync_committee_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eth_v2_sync_committee_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SyncSubcommittee); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_eth_v2_sync_committee_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_eth_v2_sync_committee_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_eth_v2_sync_committee_proto_goTypes,
		DependencyIndexes: file_eth_v2_sync_committee_proto_depIdxs,
		MessageInfos:      file_eth_v2_sync_committee_proto_msgTypes,
	}.Build()
	File_eth_v2_sync_committee_proto = out.File
	file_eth_v2_sync_committee_proto_rawDesc = nil
	file_eth_v2_sync_committee_proto_goTypes = nil
	file_eth_v2_sync_committee_proto_depIdxs = nil
}
