...
func (x *SyncSubcommitteeValidators) Reset() {
	*x = SyncSubcommitteeValidators{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v2_sync_committee_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SyncSubcommitteeValidators) Descriptor() ([]byte, []int) {
	return file_eth_v2_sync_committee_proto_rawDescGZIP(), []int{7}
}
...
var file_eth_v2_sync_committee_proto_rawDesc = []byte{
	...
	0x6b, 0x65, 0x79, 0x22, 0x5e, 0x0a, 0x21, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x50, 0x6f, 0x6f,
	0x6c, 0x53, 0x79, 0x6e, 0x63, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x65, 0x53, 0x69,
	0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x12, 0x39, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61,
	...
	0x6d, 0x69, 0x74, 0x74, 0x65, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x04, 0x64,
	0x61, 0x74, 0x61, 0x22, 0x93, 0x02, 0x0a, 0x14, 0x53, 0x79, 0x6e, 0x63, 0x43, 0x6f, 0x6d, 0x6d,
...
var file_eth_v2_sync_committee_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
func file_eth_v2_sync_committee_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_eth_v2_sync_committee_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	file_eth_v2_sync_committee_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
