...
func (*RandaoResponse_Randao) Descriptor() ([]byte, []int) {
	return file_eth_v2_beacon_state_proto_rawDescGZIP(), []int{11, 0}
}
...
var file_eth_v2_beacon_state_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
...
func file_eth_v2_beacon_state_proto_init() {
	...
	file_eth_v2_beacon_state_proto_msgTypes[7].OneofWrappers = []interface{}{
	...
	file_eth_v2_beacon_state_proto_msgTypes[10].OneofWrappers = []interface{}{}
	type x struct{}
