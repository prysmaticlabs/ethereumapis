...
func (*RandaoRequest) Descriptor() ([]byte, []int) {
	return file_eth_v2_beacon_state_proto_rawDescGZIP(), []int{11}
}
...
func (x *RandaoResponse) Reset() {
	*x = RandaoResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v2_beacon_state_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RandaoResponse) Descriptor() ([]byte, []int) {
	return file_eth_v2_beacon_state_proto_rawDescGZIP(), []int{12}
}
...
func (x *RandaoResponse_Randao) Reset() {
	*x = RandaoResponse_Randao{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v2_beacon_state_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RandaoResponse_Randao) Descriptor() ([]byte, []int) {
	return file_eth_v2_beacon_state_proto_rawDescGZIP(), []int{12, 0}
}
...
var file_eth_v2_beacon_state_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
...
func file_eth_v2_beacon_state_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_eth_v2_beacon_state_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eth_v2_beacon_state_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
	...
	file_eth_v2_beacon_state_proto_msgTypes[11].OneofWrappers = []interface{}{}
	type x struct{}
