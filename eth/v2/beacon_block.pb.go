...
func (x *BeaconBlockContainer) GetMessage() *v1alpha1.BeaconBlockAltair {
	if x != nil {
		return x.Message
	}
	return nil
...
var file_eth_v2_beacon_block_proto_rawDesc = []byte{
	...
	0x63, 0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x29, 0x0a, 0x0c, 0x42, 0x6c, 0x6f, 0x63,
	...
	0x6b, 0x49, 0x64, 0x22, 0x4a, 0x0a, 0x0d, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70,
	...
	0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x80, 0x01, 0x0a, 0x14, 0x42, 0x65, 0x61, 0x63,
	...
	0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x42, 0x80, 0x01, 0x0a, 0x13, 0x6f,
...
var file_eth_v2_beacon_block_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_eth_v2_beacon_block_proto_goTypes = []interface{}{
	(*BlockRequest)(nil),               // 0: ethereum.eth.v2.BlockRequest
	(*BlockResponse)(nil),              // 1: ethereum.eth.v2.BlockResponse
	(*BlockSSZResponse)(nil),           // 2: ethereum.eth.v2.BlockSSZResponse
	(*BeaconBlockContainer)(nil),       // 3: ethereum.eth.v2.BeaconBlockContainer
	(*v1alpha1.BeaconBlockAltair)(nil), // 4: ethereum.eth.v1alpha1.BeaconBlockAltair
}
var file_eth_v2_beacon_block_proto_depIdxs = []int32{
	3, // 0: ethereum.eth.v2.BlockResponse.data:type_name -> ethereum.eth.v2.BeaconBlockContainer
	4, // 1: ethereum.eth.v2.BeaconBlockContainer.message:type_name -> ethereum.eth.v1alpha1.BeaconBlockAltair
