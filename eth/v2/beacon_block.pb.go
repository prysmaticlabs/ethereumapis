...
var file_eth_v2_beacon_block_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x22, 0xad, 0x01, 0x0a, 0x16, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f,
...
var file_eth_v2_beacon_block_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_eth_v2_beacon_block_proto_goTypes = []interface{}{
	...
	(*SignedBeaconBlockAltair)(nil),      // 5: ethereum.eth.v2.SignedBeaconBlockAltair
	(*BeaconBlockAltair)(nil),            // 6: ethereum.eth.v2.BeaconBlockAltair
	(*BeaconBlockBodyAltair)(nil),        // 7: ethereum.eth.v2.BeaconBlockBodyAltair
	(Version)(0),                         // 8: ethereum.eth.v2.Version
	(*v1.BeaconBlock)(nil),               // 9: ethereum.eth.v1.BeaconBlock
	...
	(*v1.Attestation)(nil),               // 13: ethereum.eth.v1.Attestation
	(*v1.Deposit)(nil),                   // 14: ethereum.eth.v1.Deposit
	(*v1.SignedVoluntaryExit)(nil),       // 15: ethereum.eth.v1.SignedVoluntaryExit
	(*v1.SyncAggregate)(nil),             // 16: ethereum.eth.v1.SyncAggregate
}
var file_eth_v2_beacon_block_proto_depIdxs = []int32{
	8,  // 0: ethereum.eth.v2.BlockResponseV2.version:type_name -> ethereum.eth.v2.Version
	4,  // 1: ethereum.eth.v2.BlockResponseV2.data:type_name -> ethereum.eth.v2.SignedBeaconBlockContainerV2
	8,  // 2: ethereum.eth.v2.BlockSSZResponseV2.version:type_name -> ethereum.eth.v2.Version
	9,  // 3: ethereum.eth.v2.BeaconBlockContainerV2.phase0_block:type_name -> ethereum.eth.v1.BeaconBlock
	6,  // 4: ethereum.eth.v2.BeaconBlockContainerV2.altair_block:type_name -> ethereum.eth.v2.BeaconBlockAltair
	9,  // 5: ethereum.eth.v2.SignedBeaconBlockContainerV2.phase0_block:type_name -> ethereum.eth.v1.BeaconBlock
	...
	7,  // 8: ethereum.eth.v2.BeaconBlockAltair.body:type_name -> ethereum.eth.v2.BeaconBlockBodyAltair
	10, // 9: ethereum.eth.v2.BeaconBlockBodyAltair.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	11, // 10: ethereum.eth.v2.BeaconBlockBodyAltair.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	12, // 11: ethereum.eth.v2.BeaconBlockBodyAltair.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	13, // 12: ethereum.eth.v2.BeaconBlockBodyAltair.attestations:type_name -> ethereum.eth.v1.Attestation
	14, // 13: ethereum.eth.v2.BeaconBlockBodyAltair.deposits:type_name -> ethereum.eth.v1.Deposit
	15, // 14: ethereum.eth.v2.BeaconBlockBodyAltair.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	16, // 15: ethereum.eth.v2.BeaconBlockBodyAltair.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
