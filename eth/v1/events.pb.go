...
func (*EventBlobSidecar) Descriptor() ([]byte, []int) {
	return file_eth_v1_events_proto_rawDescGZIP(), []int{7}
}
...
func (x *EventPayloadAttributeV2_BasePayloadAttribute) Reset() {
	*x = EventPayloadAttributeV2_BasePayloadAttribute{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v1_events_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_eth_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
func file_eth_v1_events_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_eth_v1_events_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
