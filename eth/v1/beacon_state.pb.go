...
type BeaconState struct {
	...
	JustificationBits           github_com_prysmaticlabs_go_bitfield.Bitvector4 `protobuf:"bytes,18,opt,name=justification_bits,json=justificationBits,proto3" json:"justification_bits,omitempty" ssz-size:"1" cast-type:"github.com/prysmaticlabs/go-bitfield.Bitvector4"`
