...
func (*SubmitValidatorRegistrationsRequest_ValidatorRegistration) Descriptor() ([]byte, []int) {
	return file_eth_v1_validator_proto_rawDescGZIP(), []int{16, 0}
}
...
func (*SubmitValidatorRegistrationsRequest_SignedValidatorRegistration) Descriptor() ([]byte, []int) {
	return file_eth_v1_validator_proto_rawDescGZIP(), []int{16, 1}
}
...
var file_eth_v1_validator_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
