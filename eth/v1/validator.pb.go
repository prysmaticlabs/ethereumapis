...
var file_eth_v1_validator_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x70, 0x72, 0x69, 0x6d, 0x69, 0x74, 0x69, 0x76, 0x65, 0x73,
	0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x52,
	0x0e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x2a,
...
var file_eth_v1_validator_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_eth_v1_validator_proto_goTypes = []interface{}{
	...
	(*PrepareBeaconProposerRequest_FeeRecipientContainer)(nil), // 12: ethereum.eth.v1.PrepareBeaconProposerRequest.FeeRecipientContainer
	(*BeaconBlock)(nil),                                        // 13: ethereum.eth.v1.BeaconBlock
}
var file_eth_v1_validator_proto_depIdxs = []int32{
	...
	13, // 4: ethereum.eth.v1.ProduceBlockResponse.data:type_name -> ethereum.eth.v1.BeaconBlock
	12, // 5: ethereum.eth.v1.PrepareBeaconProposerRequest.recipients:type_name -> ethereum.eth.v1.PrepareBeaconProposerRequest.FeeRecipientContainer
