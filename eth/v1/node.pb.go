...
type PeerCountResponse struct {
	Data                 *PeerCount `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (m *PeerCountResponse) GetData() *PeerCount {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *PeerCount) GetDisconnected() uint64 {
	if m != nil {
...
func (m *PeerCount) GetConnecting() uint64 {
	if m != nil {
		return m.Connecting
	}
	return 0
...
func (m *PeerCount) GetConnected() uint64 {
	if m != nil {
		return m.Connected
	}
	return 0
...
func (m *PeerCount) GetDisconnecting() uint64 {
	if m != nil {
...
func (*SyncInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_0637b62b723b719c, []int{13}
}
...
func init() {
	...
	proto.RegisterType((*PeerCount)(nil), "ethereum.eth.v1.PeerCount")
...
var fileDescriptor_0637b62b723b719c = []byte{
	...
	,
}
...
func (m *PeerCount) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PeerCount) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PeerCount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PeerCount) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
