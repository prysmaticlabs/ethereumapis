...
func (*StateFinalityCheckpointResponse_StateFinalityCheckpoint) Descriptor() ([]byte, []int) {
	return file_eth_v1_beacon_chain_proto_rawDescGZIP(), []int{3, 0}
}
...
var file_eth_v1_beacon_chain_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
...
func file_eth_v1_beacon_chain_proto_init() {
	...
	file_eth_v1_beacon_chain_proto_msgTypes[11].OneofWrappers = []interface{}{}
	file_eth_v1_beacon_chain_proto_msgTypes[14].OneofWrappers = []interface{}{}
	type x struct{}
