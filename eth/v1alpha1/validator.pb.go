...
type ValidatorInfo struct {
	...
	StatusTimestamp      uint64          `protobuf:"varint,5,opt,name=status_timestamp,json=statusTimestamp,proto3" json:"status_timestamp,omitempty"`
	...
	NextAttestingSlot    uint64          `protobuf:"varint,10,opt,name=next_attesting_slot,json=nextAttestingSlot,proto3" json:"next_attesting_slot,omitempty"`
	LastProposedSlot     uint64          `protobuf:"varint,11,opt,name=last_proposed_slot,json=lastProposedSlot,proto3" json:"last_proposed_slot,omitempty"`
	NextProposingSlot    uint64          `protobuf:"varint,12,opt,name=next_proposing_slot,json=nextProposingSlot,proto3" json:"next_proposing_slot,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *ValidatorInfo) GetStatusTimestamp() uint64 {
	if m != nil {
...
func (m *ValidatorInfo) GetNextAttestingSlot() uint64 {
	if m != nil {
		return m.NextAttestingSlot
	}
	return 0
}
...
func (m *ValidatorInfo) GetNextProposingSlot() uint64 {
	if m != nil {
		return m.NextProposingSlot
	}
	return 0
}
...
var fileDescriptor_f8ef4b6a7db76675 = []byte{
	...
	,
}
