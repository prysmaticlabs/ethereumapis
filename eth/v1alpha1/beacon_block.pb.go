...
type Deposit_DataWithoutSignature struct {
	PublicKey             []byte   `protobuf:"bytes,1,opt,name=public_key,json=publicKey,proto3" json:"public_key,omitempty"`
	WithdrawalCredentials []byte   `protobuf:"bytes,2,opt,name=withdrawal_credentials,json=withdrawalCredentials,proto3" json:"withdrawal_credentials,omitempty"`
	Amount                uint64   `protobuf:"varint,3,opt,name=amount,proto3" json:"amount,omitempty"`
	XXX_NoUnkeyedLiteral  struct{} `json:"-"`
...
func (m *Deposit_DataWithoutSignature) Reset()         { *m = Deposit_DataWithoutSignature{} }
func (m *Deposit_DataWithoutSignature) String() string { return proto.CompactTextString(m) }
func (*Deposit_DataWithoutSignature) ProtoMessage()    {}
func (*Deposit_DataWithoutSignature) Descriptor() ([]byte, []int) {
	return fileDescriptor_6abbd9d98bd3d11a, []int{5, 1}
}

func (m *Deposit_DataWithoutSignature) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Deposit_DataWithoutSignature.Unmarshal(m, b)
}
func (m *Deposit_DataWithoutSignature) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Deposit_DataWithoutSignature.Marshal(b, m, deterministic)
}
func (m *Deposit_DataWithoutSignature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Deposit_DataWithoutSignature.Merge(m, src)
}
func (m *Deposit_DataWithoutSignature) XXX_Size() int {
	return xxx_messageInfo_Deposit_DataWithoutSignature.Size(m)
}
func (m *Deposit_DataWithoutSignature) XXX_DiscardUnknown() {
	xxx_messageInfo_Deposit_DataWithoutSignature.DiscardUnknown(m)
}

var xxx_messageInfo_Deposit_DataWithoutSignature proto.InternalMessageInfo

func (m *Deposit_DataWithoutSignature) GetPublicKey() []byte {
	if m != nil {
		return m.PublicKey
	}
	return nil
...
func (m *Deposit_DataWithoutSignature) GetWithdrawalCredentials() []byte {
	if m != nil {
		return m.WithdrawalCredentials
	}
	return nil
...
func (m *Deposit_DataWithoutSignature) GetAmount() uint64 {
	if m != nil {
		return m.Amount
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*Deposit_DataWithoutSignature)(nil), "ethereum.eth.v1alpha1.Deposit.DataWithoutSignature")
...
var fileDescriptor_6abbd9d98bd3d11a = []byte{
	...
	,
}
