...
type BeaconBlockBody struct {
	...
	ApplicationPayload   *ApplicationPayload    `protobuf:"bytes,9,opt,name=application_payload,json=applicationPayload,proto3" json:"application_payload,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *BeaconBlockBody) GetApplicationPayload() *ApplicationPayload {
	if m != nil {
...
var fileDescriptor_6abbd9d98bd3d11a = []byte{
	...
	,
}
...
func (m *BeaconBlockBody) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ApplicationPayload != nil {
		{
			size, err := m.ApplicationPayload.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *IndexedAttestation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AttestingIndices) > 0 {
		dAtA14 := make([]byte, len(m.AttestingIndices)*10)
		var j13 int
		...
		i = encodeVarintBeaconBlock(dAtA, i, uint64(j13))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *BeaconBlockBody) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ApplicationPayload", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ApplicationPayload == nil {
				m.ApplicationPayload = &ApplicationPayload{}
			}
			if err := m.ApplicationPayload.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
