...
type StreamPendingBlocksRequest struct {
	// Types that are valid to be assigned to QueryFilter:
	//	*StreamPendingBlocksRequest_FromSlot
	QueryFilter          isStreamPendingBlocksRequest_QueryFilter `protobuf_oneof:"query_filter"`
	XXX_NoUnkeyedLiteral struct{}                                 `json:"-"`
	XXX_unrecognized     []byte                                   `json:"-"`
	XXX_sizecache        int32                                    `json:"-"`
}

func (m *StreamPendingBlocksRequest) Reset()         { *m = StreamPendingBlocksRequest{} }
func (m *StreamPendingBlocksRequest) String() string { return proto.CompactTextString(m) }
func (*StreamPendingBlocksRequest) ProtoMessage()    {}
func (*StreamPendingBlocksRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e33ad64d6ced77c1, []int{8}
}
func (m *StreamPendingBlocksRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StreamPendingBlocksRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StreamPendingBlocksRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *StreamPendingBlocksRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StreamPendingBlocksRequest.Merge(m, src)
}
func (m *StreamPendingBlocksRequest) XXX_Size() int {
	return m.Size()
}
func (m *StreamPendingBlocksRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_StreamPendingBlocksRequest.DiscardUnknown(m)
}

var xxx_messageInfo_StreamPendingBlocksRequest proto.InternalMessageInfo

type isStreamPendingBlocksRequest_QueryFilter interface {
	isStreamPendingBlocksRequest_QueryFilter()
	MarshalTo([]byte) (int, error)
	Size() int
}

type StreamPendingBlocksRequest_FromSlot struct {
	FromSlot github_com_prysmaticlabs_eth2_types.Slot `protobuf:"varint,1,opt,name=from_slot,json=fromSlot,proto3,oneof,casttype=github.com/prysmaticlabs/eth2-types.Slot" json:"from_slot,omitempty"`
}

func (*StreamPendingBlocksRequest_FromSlot) isStreamPendingBlocksRequest_QueryFilter() {}

func (m *StreamPendingBlocksRequest) GetQueryFilter() isStreamPendingBlocksRequest_QueryFilter {
	if m != nil {
		return m.QueryFilter
	}
	return nil
...
func (m *StreamPendingBlocksRequest) GetFromSlot() github_com_prysmaticlabs_eth2_types.Slot {
	if x, ok := m.GetQueryFilter().(*StreamPendingBlocksRequest_FromSlot); ok {
		return x.FromSlot
	}
	return 0
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*StreamPendingBlocksRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*StreamPendingBlocksRequest_FromSlot)(nil),
	}
}
...
func (*IndividualVotesRespond_IndividualVote) Descriptor() ([]byte, []int) {
	return fileDescriptor_e33ad64d6ced77c1, []int{32, 0}
}
...
func init() {
	...
	proto.RegisterType((*StreamPendingBlocksRequest)(nil), "ethereum.eth.v1alpha1.StreamPendingBlocksRequest")
...
var fileDescriptor_e33ad64d6ced77c1 = []byte{
	...
	,
}
...
type BeaconChainClient interface {
	...
	StreamNewPendingBlocks(ctx context.Context, in *StreamPendingBlocksRequest, opts ...grpc.CallOption) (BeaconChain_StreamNewPendingBlocksClient, error)
}
...
func (c *beaconChainClient) StreamNewPendingBlocks(ctx context.Context, in *StreamPendingBlocksRequest, opts ...grpc.CallOption) (BeaconChain_StreamNewPendingBlocksClient, error) {
	stream, err := c.cc.NewStream(ctx, &_BeaconChain_serviceDesc.Streams[5], "/ethereum.eth.v1alpha1.BeaconChain/StreamNewPendingBlocks", opts...)
	if err != nil {
		return nil, err
	}
...
type BeaconChainServer interface {
	...
	StreamNewPendingBlocks(*StreamPendingBlocksRequest, BeaconChain_StreamNewPendingBlocksServer) error
}
...
func (*UnimplementedBeaconChainServer) StreamNewPendingBlocks(req *StreamPendingBlocksRequest, srv BeaconChain_StreamNewPendingBlocksServer) error {
...
func _BeaconChain_StreamNewPendingBlocks_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(StreamPendingBlocksRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
...
func (m *StreamPendingBlocksRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *StreamPendingBlocksRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StreamPendingBlocksRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *StreamPendingBlocksRequest_FromSlot) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StreamPendingBlocksRequest_FromSlot) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarintBeaconChain(dAtA, i, uint64(m.FromSlot))
	i--
	dAtA[i] = 0x8
	return len(dAtA) - i, nil
}
...
func (m *StreamPendingBlocksRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StreamPendingBlocksRequest_FromSlot) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sovBeaconChain(uint64(m.FromSlot))
	return n
}
...
func (m *StreamPendingBlocksRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StreamPendingBlocksRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StreamPendingBlocksRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			m.QueryFilter = &StreamPendingBlocksRequest_FromSlot{v}
		default:
			iNdEx = preIndex
			skippy, err := skipBeaconChain(dAtA[iNdEx:])
			if err != nil {
