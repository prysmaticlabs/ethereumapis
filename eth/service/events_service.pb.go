...
// 	protoc        v3.15.8
// source: eth/service/events_service.proto
...
var file_eth_service_events_service_proto_rawDesc = []byte{
...
var file_eth_service_events_service_proto_goTypes = []interface{}{
	(*v1.StreamEventsRequest)(nil), // 0: ethereum.eth.v1.StreamEventsRequest
	(*gateway.EventSource)(nil),    // 1: gateway.EventSource
}
var file_eth_service_events_service_proto_depIdxs = []int32{
...
func init() { file_eth_service_events_service_proto_init() }
func file_eth_service_events_service_proto_init() {
	if File_eth_service_events_service_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_eth_service_events_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_eth_service_events_service_proto_goTypes,
		DependencyIndexes: file_eth_service_events_service_proto_depIdxs,
	}.Build()
	File_eth_service_events_service_proto = out.File
	file_eth_service_events_service_proto_rawDesc = nil
	file_eth_service_events_service_proto_goTypes = nil
	file_eth_service_events_service_proto_depIdxs = nil
}
...
var _Events_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "eth/service/events_service.proto",
}
