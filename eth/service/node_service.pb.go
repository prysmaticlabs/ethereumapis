...
var file_eth_service_node_service_proto_rawDesc = []byte{
...
var file_eth_service_node_service_proto_goTypes = []interface{}{
...
var file_eth_service_node_service_proto_depIdxs = []int32{
...
func init() { file_eth_service_node_service_proto_init() }
func file_eth_service_node_service_proto_init() {
	if File_eth_service_node_service_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_eth_service_node_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_eth_service_node_service_proto_goTypes,
		DependencyIndexes: file_eth_service_node_service_proto_depIdxs,
	}.Build()
	File_eth_service_node_service_proto = out.File
	file_eth_service_node_service_proto_rawDesc = nil
	file_eth_service_node_service_proto_goTypes = nil
	file_eth_service_node_service_proto_depIdxs = nil
}
...
var _BeaconNode_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "eth/service/node_service.proto",
}
