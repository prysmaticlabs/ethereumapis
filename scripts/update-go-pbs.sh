...
bazel query 'kind(go_library, //...) union kind(go_proto_library, //...)' | xargs bazel build -s --explain=/tmp/exp.txt --verbose_explanations "--protocopt=--experimental_allow_proto3_optional"
